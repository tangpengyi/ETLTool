<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Http协议</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form ref="reqFrom" :model="reqFrom" label-width="80px">
      <el-form-item label="请求地址:">
        ...
        <el-input placeholder="请求地址" v-model="reqFrom.reqUrl" style="width:70%" class="input-with-select">
          <el-select v-model="reqFrom.reqStyle" @change="changeReqStyle" style="width:90px" slot="prepend">
            <el-option
    ...
    <el-tabs v-model="reqFrom.activeName" @tab-click="">
      <el-tab-pane label="x-www-form-urlencoded" name="first">
        ...
        <el-switch v-model="isParam" @change="isNeedParam()" active-text="参数" inactive-text="无需参数"></el-switch>

        <el-card class="educationExperienceTable" v-if="isParam">
          <el-table :data="this.reqFrom.reqParam" stripe border>

            <el-table-column label="参数名称" align="center" width="136px">
            ...
            <el-table-column label="参数值" align="center" width="500px">
              <template slot-scope="scope">
                <div class="educationExperienceDiv">
      ...
      <el-tab-pane label="json" name="second">
        <textarea rows="10" cols="120" style="font-size:16px;" v-model="reqFrom.postReqContext"></textarea>
      </el-tab-pane>
  ...
  export default {
    ...
    methods: {
      changeReqStyle(value) {
        if ("POST" == value) {
          console.log("post")
          this.reqFrom.activeName = 'second';
        } else {
          console.log("get")
      ...
      reqTest() {
        ...
        this.axios.post('http://localhost:8080/test/getReqTest',
          {
      ...
      isNeedParam(){
        ...
        console.log(this.reqFrom.reqParam);
      }
    }
  }
</script>
